...
class MatchRepository extends BaseRepository
{
    ...
    {
        $query = "INSERT INTO matches (organizer_id, home_team_id, away_team_id, venue_id, match_datetime, duration_min, total_seats, status) 
                  VALUES (:organizer_id, :home_team_id, :away_team_id, :venue_id, :match_datetime, :duration_min, :total_seats, :status)";
