...
<head>
    ...
    <title>Manage Teams | BuyMatch Admin</title>
        ...
        <div class="max-w-6xl mx-auto w-full">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php foreach ($teams as $team): ?>
                    <div class="glass border border-slate-700/50 rounded-[2rem] p-6 hover:border-indigo-500/50 transition-all group text-left">
