...
<head>
    ...
    <title>Create Team | BuyMatch Admin</title>
...
<body class="bg-[#0f172a] text-slate-200">
        ...
        <div class="max-w-2xl mx-auto w-full">
            ...
            <div class="glass border border-slate-700/50 rounded-[2.5rem] p-10 shadow-2xl">
                <form id="createTeamForm" class="space-y-8" enctype="multipart/form-data">
                    ...
                    <div class="space-y-4">
                        <label class="text-xs font-bold text-slate-500 uppercase ml-2 text-left block">Team Name</label>
                    ...
                    <div class="space-y-4">
                        <label class="text-xs font-bold text-slate-500 uppercase ml-2 text-left block">Team Logo</label>
    ...
    <script>
        ...
        document.getElementById('createTeamForm').addEventListener('submit', async function(e) {
            ...
            try {
                const response = await fetch('<?= BASE_URL ?>/actions/teams/create.action.php', {
                    method: 'POST',
                    body: formData
                });
